...
struct OculusTextureBuffer {
    ...
    void SetAndClearRenderSurface() {
        ...
        // store current FGO ID to recover in UnserRenderSurface().
        fboId_old= kvs::OpenGL::Integer( GL_FRAMEBUFFER_BINDING );

        // {
        //     std::cerr << "OculusTextureBuffer::SetAndClearRenderSurface(): change FBO : " << fboId_old << "->" << fboId << std::endl;
        // }
    ...
    void UnsetRenderSurface() {
        // {
        //     int fboId_cur= kvs::OpenGL::Integer( GL_FRAMEBUFFER_BINDING );
        //     std::cerr << "OculusTextureBuffer::UnsetRenderSurface(): recover FBO : (" << fboId_cur << ")->" << fboId << "->" << fboId_old << std::endl;
        // }
        ...
        glFramebufferTexture2D(GL_FRAMEBUFFER, GL_DEPTH_ATTACHMENT,
        GL_TEXTURE_2D, 0, 0);
        glBindFramebufferEXT(GL_FRAMEBUFFER, fboId_old);
    }
