...
bool ImGui::SliderFloat(const char* label, float* v, float v_min, float v_max, const char* format, float power)
{
    ...
    // {
    //     ImGuiContext& g = *GImGui;
    //     std::cerr << "ImGui::SliderFloat() : g.NavId = " << g.NavId << ", DC.LastItemId = " << g.NavWindow->DC.LastItemId << ")" << std::endl;
    // }
...
bool ImGui::SliderInt(const char* label, int* v, int v_min, int v_max, const char* format)
{
    ...
    // {
    //     ImGuiContext& g = *GImGui;
    //     std::cerr << "ImGui::SliderInt() : g.NavId = " << g.NavId << ", DC.LastItemId = " << g.NavWindow->DC.LastItemId << ")" << std::endl;
    // }
...
bool ImGui::InputFloat(const char* label, float* v, float step, float step_fast, const char* format, ImGuiInputTextFlags flags)
{
    ...
    // {
    //     ImGuiContext& g = *GImGui;
    //     std::cerr << "ImGui::InputFloat() start : g.NavId = " << g.NavId << ", DC.LastItemId = " << g.NavWindow->DC.LastItemId << ")" << std::endl;
    // }
...
bool ImGui::ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags)
{
    ...
    if (picker_active_window && g.ActiveId != 0 && g.ActiveIdWindow == picker_active_window) {
        ...
        // DEBUG_FOCUS
        // std::cerr << "ImGui::ColorEdit4() : update DC.LastItemId : " << window->DC.LastItemId << " -> " << g.ActiveId << std::endl;
