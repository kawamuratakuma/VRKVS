...
bool ImGui::ItemAdd(const ImRect& bb, ImGuiID id, const ImRect* nav_bb_arg)
{
    ...
    if (id != 0)
    {
        ...
        // DEBUG_FOCUS
        // std::cerr << "ImGui::ItemAdd(): update DC.LastItemId : " << window->DC.LastItemId << " -> " << id << std::endl;
...
bool ImGui::IsItemFocused()
{
    ...
    // DEBUG_FOCUS
    // std::cerr << "ImGui::IsItemFocused() : g.NavId = " << g.NavId << ", DC.LastItemId = " << g.NavWindow->DC.LastItemId << ")" << std::endl;
...
bool ImGui::Begin(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
    ...
    if (first_begin_of_the_frame)
    {
        ...
        */
        ...
        // DEBUG_FOCUS
        // std::cerr << "ImGui::Begin(): update DC.LastItemId : " << window->DC.LastItemId << " -> " << window->MoveId << std::endl;
...
void ImGui::SetItemDefaultFocus()
{
    ...
    if (g.NavWindow == window->RootWindowForNav && (g.NavInitRequest || g.NavInitResultId != 0) && g.NavLayer == g.NavWindow->DC.NavLayerCurrent)
    {
        ...
        // DEBUG_FOCUS
        // std::cerr << "ImGui::SetItemDefaultFocus() : set g.NavInitResultId to DC.LastItemId (" << g.NavWindow->DC.LastItemId << ")" << std::endl;
...
void ImGui::EndGroup()
{
    ...
    if ((group_data.BackupActiveIdIsAlive != g.ActiveId) && (g.ActiveIdIsAlive == g.ActiveId) && g.ActiveId) {
        ...
        // DEBUG_FOCUS
        // std::cerr << "ImGui::EndGroup(1): update DC.LastItemId : " << window->DC.LastItemId << " -> " << g.ActiveId << std::endl;
        ...
        // DEBUG_FOCUS
        // std::cerr << "ImGui::EndGroup(2): update DC.LastItemId : " << window->DC.LastItemId << " -> " << g.ActiveIdPreviousFrame << std::endl;
...
bool ImGui::BeginDragDropSource(ImGuiDragDropFlags flags)
{
    ...
    if (!(flags & ImGuiDragDropFlags_SourceExtern))
    {
        ...
        if (source_id == 0)
        {
            ...
            ImGuiID new_id = window->GetIDFromRectangle(window->DC.LastItemRect);

        // DEBUG_FOCUS
        // std::cerr << "ImGui::BeginDragDropSource(): update DC.LastItemId : " << window->DC.LastItemId << " -> " << new_id << std::endl;

            source_id = window->DC.LastItemId = new_id;
